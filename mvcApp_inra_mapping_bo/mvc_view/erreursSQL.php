...
<?php
	...
	$fichierLog = fopen(constant("CHEMIN_RACINE")."/log_error_sql.txt", "r");
?>
<h3 class="titre_partie">Voir les erreurs SQL</h3>

<p class="introduction_partie">Ici vous pouvez voir toutes les erreurs et avertissements que la BDD a rencontr&eacute;.</p>

<div class="containeur_erreur">
<?php
	// Si le fichier existe et est ouvert
	if ($fichierLog !== false) {
		if (!is_writable(constant("CHEMIN_RACINE")."/log_error_sql.txt")) {
?>
